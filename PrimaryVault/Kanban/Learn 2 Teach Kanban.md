...
- [ ] Teaching thru Inquiry<br>---<br>- [x] Perform round 1 based on EG data<br>- [x] Use a spreadsheet as a report
...
- [x] Moderation PLD<br>---<br>***Assessor Practice Tool (APT)***<br><br>[APT Pilot Site](https://apt-pilot.nzqa.govt.nz/) using the teacher’s Education Sector Logon
- [x] Explore > Code Avengers<br>---<br>[Profile | Code Avengers](https://www.codeavengers.com/profile#tab-library)<br>- [ ] Curriculum ties<br>- [ ] Y9/10 relevance<br>- [ ] Y11-13 relevance
- [x] EdPay Setup<br>---<br>- [x] Complete NOVO7t<br>- [x] Getting certified copies of quals - see Work2Do<br>- [x] Getting statements of service for work  - see Work2Do
- [x] Y12/13 score card<br>---<br>- [x] Need to combine task logs<br>- [x] Add a screen in SP to show status for 12 vs 13.
- [x] Y9/10 calendar actions<br>---<br>- [ ] use calendar for prep<br>- [ ] break tasks into periods<br>- [ ] groups get an opportunity to complete something but must submit based on deadline
- [x] Stretching
- [x] Student surveys<br>---<br>- [x] What knowledge and experience do my students have?<br>- [x] Review year 9 surveys
- [x] Light run
- [x] Identity thru Minecraft<br>---<br>- [x] taxonomy of identity<br>- [x] new id gained through games or discoveries
- [x] Account setup<br>---<br>- [x] Go through OneNote notes looking for accounts I need to setup
- [x] Y12 assessment checkup<br>---<br>- [ ] Update KAMAR markbook with student selection of ASs
- [x] Repton House<br>---<br>- [x] Fill doc re performance
